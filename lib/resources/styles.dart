...
class CustomStyles {
  static const TextStyle dateTitle = const TextStyle(fontFamily: "Archivo", fontSize: Dimens.dateSize);
  static const TextStyle treatmentTitleStyle = const TextStyle(fontFamily: "Archivo-Bold", fontSize: Dimens.titleSize);
